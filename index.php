...
<body style="background-color: #FDF5E6;">
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2F4F4F;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Poliklinik Harapan Bangsa</a>
    ...
    if (isset($_GET['page'])) {
        ...
        echo "<center><br><h2>Selamat Datang di Sistem Informasi Poliklinik Harapan Bangsa</center>";

        if (isset($_SESSION['username' . 'nama'])) {
            // jika sudah login tampilkan username
            echo ", " . $_SESSION['username' . 'nama'] . "</h2><hr>";
        } else {
            echo "<center></h2><hr>Silakan Login untuk menggunakan sistem. Jika belum memiliki akun silakan Register terlebih dahulu.</center>";
        }
    }
    ?>
</body>
